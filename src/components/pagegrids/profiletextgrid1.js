...
function ProfileTextGrid1() {
  ...
  return (
    <Grid container className={classes.root} spacing={7} justify="center">
        <Grid item xs={12} md={6} className={classes.paper}> I'm a second year student at the University of Jyväskylä. I am studying information systems science as my major and economics as a minor.</Grid>
