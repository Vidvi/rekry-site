...
function ProjectTextGrid2() {
  ...
  return (
    <Grid container className={classes.root} spacing={7} justify="center">
        <Grid item xs={12} md={6} className={classes.paper}> There's a few projects in my Github. <a href="https://github.com/Vidvi?tab=repositories" target="_blank">View them here.</a> It's always expanding when I'm working on new projects.</Grid>
